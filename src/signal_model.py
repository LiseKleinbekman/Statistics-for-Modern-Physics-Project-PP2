...
def predicted_sb_counts(mjj_centers, bin_widths, bkg_params, N_sig, m0, sigma,
                        n_bkg_params=4, sqrt_s_TeV=13.0, A=1.0):
    """
...
def fit_signal_plus_background(mjj_centers, bin_widths, counts,
                                ...
                                n_bkg_params=4, sqrt_s_TeV=13.0,
    ...
    def objective(params):
        return neg_log_likelihood(params, mjj_centers, bin_widths, counts,
                               n_bkg_params, sqrt_s_TeV,
                               fix_m0=m0 if fix_m0 else None,
                               fix_sigma=sigma if fix_sigma else None)
